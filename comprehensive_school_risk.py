...
class SchoolRiskMapper:
    ...
    def __init__(self, country_name="Unknown", data_dir=None, config=None):
        ...
        self.analysis_params = config.get('analysis_params', {
            ...
            'infrastructure_age_indicators': {
                'modern_keywords': ['gимназия', 'лицей', 'центр', 'modern', 'new', 'academy'],
    ...
    def load_data(self, healthcare_file=None, education_file=None, roads_file=None, auto_detect=True):
        ...
        if auto_detect:
            ...
            healthcare_file = self._auto_detect_file(['healthcare', 'health', 'hospital', 'clinic'], 
                                                   ['csv', 'geojson', 'shp'])
        ...
        if healthcare_file and Path(healthcare_file).exists():
            self.healthcare_facilities = self._load_geospatial_file(healthcare_file)
